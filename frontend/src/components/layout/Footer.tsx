...
// Set href to the real community URL to enable an icon (renders as a link again).
const SOCIALS = [
  { icon: <RedditIcon />,    href: null, label: 'Reddit' },
  { icon: <XIcon />,         href: null, label: 'X (Twitter)' },
  { icon: <InstagramIcon />, href: null, label: 'Instagram' },
]
          ...
          {SOCIALS.map((social) => (
            social.href ? (
              ...
              <span
                ...
                title="Coming soon"
                className="text-ink/25 cursor-not-allowed select-none"
              >
                {social.icon}
              </span>
            )
